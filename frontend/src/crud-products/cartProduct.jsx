...
//     const [orderId, setOrderId] = useState(null); // Initialisez-le avec la valeur de l'ID de commande ou null


//     useEffect(() => {
//         // Mettez à jour la commande avec les produits du panier
//         const updatedOrder = {
//         //   idUser: userId, // Remplacez userId par l'ID de l'utilisateur actuel
//           articles: cart.map((product) => product.title), // Utilisez les titres des produits
//           articlesPrices: cart.map((product) => product.price), // Utilisez les prix des produits
//           price: cart.reduce((total, product) => total + product.price * product.quantity, 0), // Calculez le prix total
//         };
//         // Appelez la fonction pour mettre à jour la commande
//         updatedOrder(orderId, updatedOrder); // Assurez-vous d'avoir l'ID de la commande actuelle (orderId)
//       }, [cart, orderId]);
